...
class Product {
    ...
    // Neuer Initializer mit zusätzlichen Parametern und Default-Werten für optionale Eigenschaften
...
// Erstellen von 40 Dummy-Produkten (15 Lebensmittel, 15 Getränke, 10 Süßwaren)
